...
public class MembershipResponse {
	...
	public static class Complete {
		...
		public static Complete of(Long artistId, String artistName, Long amount, String joinedAt, String nextBillingAt) {
			return new Complete(artistId, artistName, "월간 멤버십", amount, joinedAt, nextBillingAt);
		}
